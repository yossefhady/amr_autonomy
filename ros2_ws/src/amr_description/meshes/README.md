...
This directory is reserved for 3D mesh files (STL, DAE, or OBJ formats) that can be used to enhance the visual representation of the AMR robot.
...
```xml
<mesh filename="package://amr_description/meshes/your_mesh_file.stl" scale="1 1 1"/>
```
