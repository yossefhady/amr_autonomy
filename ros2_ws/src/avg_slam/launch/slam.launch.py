#!/usr/bin/env python3
"""
SLAM Launch File for AVG Robot
================================
...
def generate_launch_description():
    ...
    # Default paths
    default_slam_params = os.path.join(pkg_avg_slam, 'params', 'slam_params.yaml')
    default_rviz_config = os.path.join(pkg_avg_slam, 'rviz', 'slam_view.rviz')
