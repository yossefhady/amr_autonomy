#!/bin/bash
# Map Saving Helper Script for AMR SLAM
...
echo "=================================================="
echo "🗺️  AMR SLAM Map Saving Utility"
echo "=================================================="
echo ""

# Default output directory
DEFAULT_DIR="/home/yossef/amr_autonomy/ros2_ws/src/amr_navigation/maps"
...
echo "   ros2 launch amr_navigation navigation.launch.py map:=$FULL_PATH.yaml"
echo ""
